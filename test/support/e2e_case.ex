defmodule Powervisor.E2ECase do
  use ExUnit.CaseTemplate

  @repo Powervisor.Repo
  ...
  setup tags do
    ...
    Powervisor.DataCase.setup_sandbox(tags)
  end
  ...
  def create_instance(external_id) do
    ...
    assert {:ok, tenant} =
             Powervisor.Tenants.create_tenant(%{
    ...
    on_exit(fn ->
      _ = Powervisor.stop({{:single, external_id}, "postgres", :session, external_id, nil})
      _ = Powervisor.stop({{:single, external_id}, "postgres", :transaction, external_id, nil})
