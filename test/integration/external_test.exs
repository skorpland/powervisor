defmodule Powervisor.Integration.ExternalTest do
  ...
  defp port("session"), do: Application.fetch_env!(:powervisor, :proxy_port_session)
  defp port("transaction"), do: Application.fetch_env!(:powervisor, :proxy_port_transaction)
end
