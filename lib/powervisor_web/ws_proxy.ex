defmodule PowervisorWeb.WsProxy do
  @moduledoc """
  The `Powervisor.WsProxy` module implements a WebSocket proxy for managing
  ...
  defp connect_local do
    proxy_port = Application.fetch_env!(:powervisor, :proxy_port_transaction)
