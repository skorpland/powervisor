defmodule PowervisorWeb.ClusterController do
  use PowervisorWeb, :controller

  require Logger

  alias Powervisor.Repo
  alias Powervisor.Tenants
  alias Powervisor.Tenants.Cluster, as: ClusterModel
    ...
    case Tenants.get_cluster_by_alias(id) do
      ...
      cluster ->
        ...
        with {:ok, %ClusterModel{} = cluster} <-
          ...
          result = Powervisor.terminate_global("cluster.#{cluster.alias}")
