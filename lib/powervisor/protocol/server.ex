defmodule Powervisor.Protocol.Server do
  @moduledoc """
  The Powervisor.Protocol.Server module is responsible for decoding data received from the PostgreSQL server. It provides several functions to decode payloads from different types of messages.

  Message Formats: https://www.postgresql.org/docs/current/protocol-message-formats.html
  Error codes https://www.postgresql.org/docs/current/errcodes-appendix.html
  """
  require Logger
  alias Powervisor.Protocol.PgType
  ...
  @application_name <<?S, 31::32, "application_name", 0, "Powervisor", 0>>
    ...
    bin =
      Enum.reduce(payload, "", fn
        ...
        {"application_name" = k, v}, acc ->
          <<k::binary, 0, v::binary, " via Powervisor", 0>> <> acc
