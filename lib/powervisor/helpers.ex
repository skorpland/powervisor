defmodule Powervisor.Helpers do
  @moduledoc false
  require Logger
  ...
  ## Examples
      ...
      iex> Powervisor.Helpers.parse_pg_version("PostgreSQL 14.6 (Debian 14.6-1.pgdg110+1) some string")
      {:ok, "14.6 (Debian 14.6-1.pgdg110+1)"}

      iex> Powervisor.Helpers.parse_pg_version("PostgreSQL 15.1 on aarch64-unknown-linux-gnu, compiled by gcc (Ubuntu 10.3.0-1ubuntu1~20.04) 10.3.0, 64-bit")
      {:ok, "15.1"}

      iex> Powervisor.Helpers.parse_pg_version("PostgreSQL on x86_64-pc-linux-gnu")
  ...
  ## Examples
      ...
      iex> Powervisor.Helpers.ip_version(:v4, "example.com")
      :inet
      iex> Powervisor.Helpers.ip_version(:v6, "example.com")
      :inet6
      iex> Powervisor.Helpers.ip_version(nil, "example.com")
      :inet
  """
  ...
  ## Examples
      ...
      iex> Powervisor.Helpers.detect_ip_version("example.com")
      :inet
      iex> Powervisor.Helpers.detect_ip_version("ipv6.example.com")
      :inet6
  """
  ...
  def upstream_cert(default) do
    Application.get_env(:powervisor, :global_upstream_ca) || default
  end

  @spec downstream_cert() :: Path.t() | nil
  def downstream_cert do
    Application.get_env(:powervisor, :global_downstream_cert)
  end

  @spec downstream_key() :: Path.t() | nil
  def downstream_key do
    Application.get_env(:powervisor, :global_downstream_key)
  end
  ...
  @spec controlling_process(Powervisor.sock(), pid) :: :ok | {:error, any()}
  ...
  @max_length Application.compile_env(:powerbase, :namedatalen, 64) - 1
