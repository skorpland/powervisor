defmodule Powervisor.SignalHandler do
  @moduledoc """
  Powervisor.SignalHandler is a module that provides a custom signal handling behavior
  for the Powervisor application. It implements the :gen_event behavior and intercepts
