defmodule Powervisor.Tenants.Tenant do
  @moduledoc false

  use Ecto.Schema
  import Ecto.Changeset
  alias Powervisor.Tenants.User
  ...
  def changeset(tenant, attrs) do
    ...
    |> check_constraint(:upstream_ssl, name: :upstream_constraints, prefix: "_powervisor")
    |> check_constraint(:upstream_verify, name: :upstream_constraints, prefix: "_powervisor")
    |> validate_required([
      :default_parameter_status,
      :external_id,
      :db_host,
  ...
  ## Examples
    ...
    iex> changeset =
    iex> Ecto.Changeset.change(%Powervisor.Tenants.Tenant{}, %{allow_list: ["0.0.0.0"]})
    iex> |> Powervisor.Tenants.Tenant.validate_allow_list()
    iex> changeset.errors
    [allow_list: {"Invalid CIDR range: 0.0.0.0", []}]

    iex> changeset =
    iex> Ecto.Changeset.change(%Powervisor.Tenants.Tenant{}, %{allow_list: ["0.0.0.0/0", "::/0"]})
    iex> |> Powervisor.Tenants.Tenant.validate_allow_list()
    iex> changeset.errors
    []

    iex> changeset =
    iex> Ecto.Changeset.change(%Powervisor.Tenants.Tenant{}, %{allow_list: ["0.0.0.0/0", "foo", "bar"]})
    iex> |> Powervisor.Tenants.Tenant.validate_allow_list()
    iex> changeset.errors
    [{:allow_list, {"Invalid CIDR range: foo", []}}, {:allow_list, {"Invalid CIDR range: bar", []}}]

    iex> changeset =
    iex> Ecto.Changeset.change(%Powervisor.Tenants.Tenant{}, %{allow_list: ["0.0.0.0/0   "]})
    iex> |> Powervisor.Tenants.Tenant.validate_allow_list()
    iex> changeset.errors
    []
  """
