defmodule Powervisor.Tenants.User do
  @moduledoc false
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field(:db_password, Powervisor.Encrypted.Binary, source: :db_pass_encrypted)
    ...
    belongs_to(:tenant, Powervisor.Tenants.Tenant, foreign_key: :tenant_external_id, type: :string)
    timestamps()
  end
