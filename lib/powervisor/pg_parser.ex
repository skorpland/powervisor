defmodule Powervisor.PgParser do
  @moduledoc false

  use Rustler, otp_app: :powervisor, crate: "pgparser"
  ...
  ## Examples
      ...
      iex> Powervisor.PgParser.statement_types("select 1; insert into table1 values ('a', 'b')")
      {:ok, ["SelectStmt", "InsertStmt"]}

      iex> Powervisor.PgParser.statement_types("not a valid sql")
