defmodule Powervisor.MetricsCleaner do
  @moduledoc false
  ...
  def init(_args) do
    ...
    :telemetry.attach(
      {__MODULE__, :report},
      [:powervisor, :metrics_cleaner, :stop],
  ...
  def handle_continue(:clean, state) do
    ...
    :telemetry.span([:powervisor, :metrics_cleaner], %{}, fn ->
  ...
  defp loop_and_cleanup_metrics_table do
    {_, tids} = Peep.Persistent.storage(Powervisor.Monitoring.PromEx.Metrics)
